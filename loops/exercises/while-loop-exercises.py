...
while astronauts_aboard < 1 or astronauts_aboard > 7:
 astronauts_aboard = int(input("Please enter a the number of astronauts on board between 1-7: "))
...
print("the shuttle gained an altitude of", shuttle_altitude,"km and has", fuel_level, "kg of fuel left", ending)