...
# If fuel_level is above 20000 AND engine_indicator_light is NOT red blinking OR command_override is true 
# print "Cleared to launch!" Else print "Launch scrubbed!"

if command_override:
   print("Launch Initiated")
elif fuel_level > 20000 and engine_indicator_light != "red blinking": 
   print("fuel and engine checked. Launch Initiated")
else:
