...
first_letter_removed = cargo_hold.pop(0)
print(first_letter_removed)
print(cargo_hold)
# append and insert require arguments inside the (). Add the items 1138 and ‘20 meters’ to the the list - the number 
# at the start and the string at the end. Print the updated list to confirm the changes.
